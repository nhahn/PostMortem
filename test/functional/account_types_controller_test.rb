...
class AccountTypesControllerTest < ActionController::TestCase
  ...
  test "should create account_type" do
    assert_difference('AccountType.count') do
      post :create, account_type: { name: @account_type.name, permissions: @account_type.permissions, username_regex: @account_type.username_regex }
    end
  ...
  test "should update account_type" do
    put :update, id: @account_type, account_type: { name: @account_type.name, permissions: @account_type.permissions, username_regex: @account_type.username_regex }
    assert_redirected_to account_type_path(assigns(:account_type))
  end
